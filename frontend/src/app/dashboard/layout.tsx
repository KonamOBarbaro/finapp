    ...
    <div className="min-h-screen bg-background flex flex-col lg:flex-row">
      ...
      <aside className="w-full lg:w-72 bg-surface border-r border-surface-border lg:min-h-screen flex flex-col z-50">
        ...
        <nav className="flex-1 px-4 py-8 space-y-2">
          ...
          <Link href="/dashboard/transactions" className="flex items-center space-x-3 px-4 py-3 rounded-xl text-secondary hover:bg-surface-border hover:text-foreground font-medium transition-colors">
